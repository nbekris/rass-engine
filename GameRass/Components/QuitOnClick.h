...
class QuitOnClick : public RassEngine::Cloneable<RassEngine::Component, QuitOnClick> {
public:
	QuitOnClick();
	QuitOnClick(const QuitOnClick &other);
	virtual ~QuitOnClick() override;
...
private:
	...
	RassEngine::Events::EventListenerMethod<QuitOnClick, RassEngine::Events::EventArgs> onClick;
};
