...
// Class Definition:
class ParticleAlphaUpdater : public Cloneable<Component, ParticleAlphaUpdater> {
public:
	...
	virtual ~ParticleAlphaUpdater(void) override;
...
private:
	...
	Events::GlobalEventListener<ParticleAlphaUpdater> updateListener;
	TweenCurve curve{};
